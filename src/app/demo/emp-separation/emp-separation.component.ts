...
interface Separation {
  ...
  separationType: 'Voluntary' | 'Involuntary' | 'Retirement' | 'Resignation' | 'Termination' | 'End of Contract' | 'Dismissal' | 'Mutual Separation';
  separationReason: 'Better Opportunity' | 'Career Change' | 'Personal Reasons' | 'Health Issues' | 'Relocation' | 'Performance Issues' | 'Behavioral Issues' | 'Company Restructuring' | 'End of Contract' | 'Retirement' | 'Other';
...
export class EmpSeparationComponent implements OnInit {
  ...
  loadSeparations(): void {
    ...
    this.separations = [
      ...
      },
      {
        ...
        separationDate: '2025-08-15',
        separationType: 'Resignation',
        separationReason: 'Personal Reasons',
        status: 'Approved',
        lastWorkingDate: '2025-08-31',
        noticePeriodServed: true,
        exitInterviewDate: '2025-08-20',
  ...
  saveSeparation(): void {
    ...
    try {
      ...
      console.log('Saving separation:', separation);
      ...
      this.showError('An error occurred while saving the separation');
    }
  }
  ...
  calculateNoticePeriodDays(separationDate: string, lastWorkingDate: string): number {
    if (!separationDate || !lastWorkingDate) return 0;
    
    const start = new Date(separationDate);
